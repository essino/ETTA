...
class ItemDAOTest {
		...
		private Person lena = new Person("Lena", Date.valueOf("1980-08-10"), "elena.myllari@metropolia.fi");
		...
		public void testReadItem() {
			...
			assertEquals(lena, itemDAO.readItem(1).getPerson(), "Reading one failed (person)");
		}
		...
		public void testUpdate() {
			...
			assertEquals(price, itemDAO.readItem(1).getPrice(), "Price updating failed");
		}
		
		@Test
		@Order(5)
		public void testDelete() {
			assertEquals(true, itemDAO.deleteItem(1), "Deleting failed");
		}
